...
|------------|----------------|-------------|------|
| **AI-Enhanced** | Azure | Actual AI report with Executive Summary, Risk Assessment, Detailed Changes, Recommendations, and Approval table | [📄 View Sample](samples/azure_ai_enhanced_report.md) |
| **Basic (FREE)** | Azure | Real basic report - Resource changes with actions (create/update/destroy) and attribute changes | [📄 View Sample](samples/azure_basic_report.md) |

> **Note:** These are **actual reports generated by TerraformAI** from real Terraform plans, not mock examples. The AI report includes the signature approval table (Infrastructure Lead, Application Owner, Security Lead, Data Platform Lead).
